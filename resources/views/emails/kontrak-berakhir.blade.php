    ...
    <div style="background:#fff;margin:20px auto;border-radius:8px;overflow:hidden;max-width:600px;">
        ...
        <div style="padding:24px 32px;">
            ...
            <p style="font-size:14px;color:#374151;">
                Kontrak untuk laporan berikut telah berakhir. Mohon segera ditindaklanjuti.
            </p>
            ...
            <table style="width:100%;border-collapse:collapse;">
                ...
                <tr>
                    ...
                    <td style="font-size:13px;color:#dc2626;font-weight:bold;padding:6px 0;">
                        {{ $akhirKontrak }}
                    </td>
                </tr>
            </table>
            ...
            <a href="{{ $url }}"
               style="background-color:#1d4ed8;color:#fff;padding:12px 24px;border-radius:6px;
